...
const cursur_1 = __webpack_require__(1);
const svgWriter_1 = __webpack_require__(4);
const control_1 = __webpack_require__(7);
const svgTag = document.getElementById("svg");
const cursurSVGTag = document.getElementById("cursurSvg");
const frontBoardTag = document.getElementById("frontBoard");
const sourceTag = document.getElementById("source");
let clickMode = "grid";
const cursurBoard = new cursur_1.CursurBoard(frontBoardTag, cursurSVGTag);
const svgWriter = new svgWriter_1.SVGWriter(svgTag, sourceTag);
const controller = new control_1.Control();
...
class CursurBoard {
    constructor(div, svg) {
        ...
        this.testClick = (e) => {
            if (this.mode == "rect-end") {
                this.endRect();
                this.controller.emit("rect", lib_1.createRect(this.rectPoint, getGrid(e.offsetX, e.offsetY)));
                return;
            }
            this.startRect(e);
        };
...
exports.CursurBoard = CursurBoard;
function getGrid(x, y) {
    const gridX = Math.floor((x / const_1.GRID) + 0.5);
    const gridY = Math.floor((y / const_1.GRID) + 0.5);
    return {
        x: gridX * const_1.GRID,
        y: gridY * const_1.GRID,
    };
}
//# sourceMappingURL=cursur.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
const beautify = __webpack_require__(5);
/**
 * SVGWriter
 */
class SVGWriter {
    constructor(svg, source) {
        this.addRect = (no, p) => {
            const rect = document.createElementNS("http://www.w3.org/2000/svg", "rect");
...
Object.defineProperty(exports, "__esModule", { value: true });
const eventemitter2_1 = __webpack_require__(8);
class Control extends eventemitter2_1.EventEmitter2 {
    constructor() {
        super();
        this.setSVGWriter = (svgWriter) => {
